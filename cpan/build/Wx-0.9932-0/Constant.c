 ...
 * contents of Constant.xs. Do not edit this file, edit Constant.xs instead.
 *
...
XS_EUPXS(XS_Wx_constant); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Wx_constant)
{
    dVAR; dXSARGS;
    if (items != 3)
       croak_xs_usage(cv,  "name, arg, error");
...
XS_EUPXS(XS_Wx_UnsetConstants); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Wx_UnsetConstants)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Wx_SetEvents); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Wx_SetEvents)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Wx_SetInheritance); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Wx_SetInheritance)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Wx__get_packages); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Wx__get_packages)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
extern "C"
#endif
XS_EXTERNAL(boot_Wx_Const); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Wx_Const)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("Wx::constant", XS_Wx_constant);
        newXS_deffile("Wx::UnsetConstants", XS_Wx_UnsetConstants);
        newXS_deffile("Wx::SetEvents", XS_Wx_SetEvents);
        newXS_deffile("Wx::SetInheritance", XS_Wx_SetInheritance);
        newXS_deffile("Wx::_get_packages", XS_Wx__get_packages);
#if PERL_VERSION_LE(5, 21, 5)
